...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	insersao, erro := statement.Exec(usuario.Nome, usuario.Email)
	if erro != nil {
	...
	w.Write([]byte(fmt.Sprintf("Usario inserido com sucesso! Id: %d", idInserido)))
}
...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	db, erro := banco.Conectar()
	if erro != nil {
		w.Write([]byte("Erro ao coonectar ao banco de dados"))
		return
	}
	defer db.Close()
